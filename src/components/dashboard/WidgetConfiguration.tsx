                      ...
                      providers.map((provider) => {
                        ...
                        return (
                          <button
                            ...
                            className={`p-4 rounded-xl border-2 transition-all duration-200 hover:shadow-md relative ${isSelected
                      ...
                      <div className="space-y-1 text-sm">
                        ...
                        {selectedModel && (
                          <>
                            ...
                            {selectedModel.pricing_input && (
                              <div className="flex justify-between">
                                <span className="text-muted-foreground">
                                  Input Cost:
                                </span>
                                <span>
                                  ${selectedModel.pricing_input}/1K tokens
                                </span>
                              </div>
                            )}
                            {selectedModel.pricing_output && (
                              <div className="flex justify-between">
                                <span className="text-muted-foreground">
                                  Output Cost:
                                </span>
                                <span>
                                  ${selectedModel.pricing_output}/1K tokens
                                </span>
                              </div>
                            )}
                          </>
                  ...
                  <div className="p-4 bg-muted rounded-lg">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-muted-foreground">Model:</span>
                        <span>
                          {availableModels.find((m) => m.name === selectedModel?.name)
                            ?.display_name ||
                            selectedModel?.name ||
                            "Not selected"}
                        </span>
