import api, { getCsrfCookie, handleApiError } from "@/lib/api/config/axios";
import { LoginCredentials, RegisterData, AuthResponse, AuthUser, ForgotPasswordData, ResetPasswordData } from "@/types/auth";
